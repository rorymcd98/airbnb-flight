...
import { FlightOffersResponseSchema } from '../types-schemas/FlightOffersResponse';
export default class FlightApiClient {
    static _instance;
    _clientId;
    _clientSecret;
    _accessToken;
    _accessTokenExpiryTime = 0;
    _flightSearchParameterMap = new Map();
    _userPreferences = {};
    _AirportCodeApiClient;
    constructor(initialUserPreferences) {
    ...
    static getInstance(initialUserPreferences) {
    ...
    async getFlightOffersForListing(airbnbListingInfo) {
    ...
    async searchFlightOffers(flightSearchBody) {
...
//   },
// };
//# sourceMappingURL=flight-api-client.class.js.map