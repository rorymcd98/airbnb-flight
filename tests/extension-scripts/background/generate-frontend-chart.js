export function generateChartMeta(listingInfo, userPreferences) {
    return {
...
export function generateFrontendChartData(flightOffers, listingInfo) {
...
//# sourceMappingURL=generate-frontend-chart.js.map