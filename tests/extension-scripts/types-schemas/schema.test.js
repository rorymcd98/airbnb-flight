...
describe('userPreferencesSchema', () => {
    ...
    test('should not validate an invalid user preferences object with inconsistent times', () => {
        ...
        expect(() => userPreferencesSchema.parse(userPreferences)).toThrowError('Earliest departure/arrival time must be before latest departure/arrival time.');
    });
    test('should not validate an invalid user preferences object with invalid originLocation', () => {
        ...
        expect(() => userPreferencesSchema.parse(userPreferences)).toThrowError(/invalid_string/);
    });
