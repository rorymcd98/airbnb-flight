import { type FlightSearchBody, FlightSearchBodySchema, type OriginDestination, type Traveler, type SearchCriteria, type DateTimeRange } from '../types-schemas/FlightSearchBody'
import { type AirbnbListingInfo, type GuestCounter } from '../types-schemas/ListingInfo'
import { type UserPreferences } from '../types-schemas/UserPreferences'
import { type AirportCode } from '../types-schemas/AirportCode'
import { type TopAirportCodes } from './airportCode-api-client.class'

import hash from 'object-hash'

export default class FlightSearchParameter {
  private readonly _flightSearchBody: FlightSearchBody
  private static readonly defaultSearchCriteria: SearchCriteria = {
